                ...
                <div key={item.uid} className="card bg-dark mt-2 row p-1" style={{ width: "18rem", margin: '0 auto' }}>
                    ...
                    <div className="card-body mt-2">
                        ...
                        <div className="d-flex justify-content-between mt-5">
                            ...
                            <span href="#" className="btn btn-outline-danger text-danger"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="40" fill="currentColor" className="bi bi-heart" viewBox="0 0 16 16">
