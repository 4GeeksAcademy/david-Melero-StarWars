        ...
        <div key={item.uid} className="card  bg-dark mt-2 mb-2" style={{ width: '18rem', margin: '0 auto' }}>
          ...
          <div className="card-body">
            ...
            <div className="d-flex justify-content-between">
              ...
              <button onClick={() => {actions.addFavorites(item.name)}} className="btn btn-outline-danger text-danger"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="40" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16">
